...
import com.titus.ecommerce_tutam_cafe.repository.AddressRepository;
import com.titus.ecommerce_tutam_cafe.repository.OrderItemRepository;
import com.titus.ecommerce_tutam_cafe.repository.OrderRepository;
...
public class OrderServiceImplementation implements OrderService {
	...
	public OrderServiceImplementation(OrderRepository orderRepository, CartService cartService, AddressRepository addressRepository, UserRepository userRepository,
	...
	public Order createOrder(User user, Address shippingAddress) {
		...
		createdOrder.setDiscounts(cart.getDiscount());
	...
	public Order findOrderById(Long orderId) throws OrderException {
		...
		throw new OrderException("Thers is order with the id " + orderId);
	}
