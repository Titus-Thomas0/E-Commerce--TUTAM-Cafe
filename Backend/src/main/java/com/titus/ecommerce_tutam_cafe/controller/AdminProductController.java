...
import com.titus.ecommerce_tutam_cafe.response.ApiResponse;
import com.titus.ecommerce_tutam_cafe.service.ProductService;
...
public class AdminProductController {
	...
	public ResponseEntity<List<Product>> findAllProduct() {
		...
		List<Product> products = productService.findAllProducts(); //Have to consider in future...
